...
--------------------------------------------------------------------------
-- 2025/05/07
-- 결제 테이블 영수증 ID와 주문 ID 컬럼 추가
ALTER TABLE TB_PAYMENT_RECORD ADD RECEIPT_ID VARCHAR2(50) UNIQUE NOT NULL;
ALTER TABLE TB_PAYMENT_RECORD ADD ORDER_ID VARCHAR2(50) UNIQUE NOT NULL;